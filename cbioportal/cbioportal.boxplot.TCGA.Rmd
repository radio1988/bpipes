...
box_jitter_plot_anova2 <- function(expr, cliclass, labels=  c("Positive", "Negative"), xlab_angle=0, ylab_height=-2.5){
    # information
    nb_samples <- table(expr[, cliclass])
    print(paste('Number of samples for', cliclass))
    print(nb_samples)
...
box_jitter_plot_anova1(expr, "CANCER_TYPE_DETAILED", 
                      c("Breast Invasive Lobular Carcinoma",
                        "Invasive Breast Carcinoma",
                        "Breast Invasive Ductal Carcinoma",
                        "Breast Mixed Ductal and Lobular Carcinoma"))

box_jitter_plot_anova2(expr, "CANCER_TYPE_DETAILED", 
                      c("Breast Invasive Lobular Carcinoma",
                        "Invasive Breast Carcinoma",
                        "Breast Invasive Ductal Carcinoma",
                        "Breast Mixed Ductal and Lobular Carcinoma"),
