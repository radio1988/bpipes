...
volcanoplot <- function(res, anno,
    ...
    EnhancedVolcano(res,
                    ...
                    colAlpha = 1,
                    # legend=c('NS','Log2FoldChange','FDR',
                    #          'FDR & Log2FoldChange'),
                    legend=c("Negative",
